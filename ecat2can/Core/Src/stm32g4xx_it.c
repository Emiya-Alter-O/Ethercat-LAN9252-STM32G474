...
void SysTick_Handler(void)
{
  ...
  if((hdma_usart1_tx.State == HAL_DMA_STATE_READY) && (HAL_UART_GetState(&huart1) != HAL_UART_STATE_BUSY_TX) && (__HAL_UART_GET_FLAG(&huart1,UART_FLAG_TC)==SET))
  {
